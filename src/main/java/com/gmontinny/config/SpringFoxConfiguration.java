...
public class SpringFoxConfiguration extends WebMvcConfigurationSupport {
	...
	public Docket productApi() {
		return new Docket(DocumentationType.SWAGGER_2)
				.select()
				.apis(RequestHandlerSelectors.basePackage("com.gmontinny.controllers")).build()
				.apiInfo(metaData());
	...
	private ApiInfo metaData() {
		return new ApiInfoBuilder()
				...
				.contact(new Contact("Giovanny Montinny", "https://github.com/gmontinny", "gmontinny@gmail.com"))
				.build();
	}
